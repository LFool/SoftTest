package com.lfool.test04.controlflowgraph;
...
public class Generate extends BodyTransformer {
    ...
    //可选图类型：BriefBlockGraph"; CompleteUnitGraph";"BriefUnitGraph";
    ...
    public static void main(String[] args) {
        ...
        printTransform.setDefaultOptions("enabled "
                + altClassPathOptionName + ": " + graphTypeOptionName + ':'
                + defaultGraph + ' '
        ...
        String[] sootArgs = new String[3];
        sootArgs[0] = "--soot-classpath";
        sootArgs[1] = "target/classes/;D:/Java/jdk1.8.0_191/jre/lib/rt.jar;";
        sootArgs[2] = "com.lfool.test04.Diagnosis";
    ...
    private void initialize(Map<String, String> options) {
        if (drawer == null) {
            ...
            AltClassLoader.v()
                    .setAltClasses(new String[] {
                            "soot.toolkits.graph.ArrayRefBlockGraph", "soot.toolkits.graph.Block",
     ...
     * @param body
     */
    protected void printControlFlorGraph(Body body) {
        ...
        filename = filename + classname + " " + methodname.replace(java.io.File.separatorChar, '.')
